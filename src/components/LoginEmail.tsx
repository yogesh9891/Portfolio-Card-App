...
import { sendOtpApi, sendOtpEmailApi } from '../services/users.service';
import {
  GoogleSignin,
  GoogleSigninButton,
  statusCodes,
  ...
  const sendOtp = async () => {
    ...
    try {
      ...
      if (otpResponse.success == true) {
        ...
        navigate.navigate('OtpVerfiyEmail', { email: email })
      ...
      <View style={[internalcss.centerhei]}>
          ...
          <View style={styles.pdlr}>
            ...
            <View style={[styles.inputnuber, styles.mttop10]}>
              ...
              <TextInput placeholder='Enter Email ID'  placeholderTextColor="#ddd"  style={[styles.inputborder, styles.widhtinpu82]}  value={email} onChangeText={setemail} />
            </View>
            {
